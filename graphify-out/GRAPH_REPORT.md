...
## Corpus Check
- 98 files · ~45,316 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 296 nodes · 453 edges · 22 communities detected
...
Cohesion: 0.06
Nodes (6): initI18n(), loadResources(), handleScheduled(), handleTurkeyChecks(), checkSSLCertificate(), checkSSLExpiry()
...
Cohesion: 0.14
Nodes (13): cleanAIOutput(), generateAIBlogContent(), generateAIOutagePost(), generateAIPerformancePost(), generateAITrendPost(), generateContent(), previewAIBlogContent(), wrapContent() (+5 more)
...
## Knowledge Gaps
- **Thin community `Community 15`** (1 nodes): `validation.ts`
